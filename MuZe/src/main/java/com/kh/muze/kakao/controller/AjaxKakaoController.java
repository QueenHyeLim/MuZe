...
public class AjaxKakaoController {
	...
	public String gokakaoPay(String musTitle, String musId, String theaterName, String selectdate, String selectseat, String totalPrice, HttpSession session) throws ParseException, Exception {
